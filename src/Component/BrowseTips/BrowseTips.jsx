  ...
  return (
    <div className="w-[95%] md:w-full mx-auto my-6">
      ...
      <div className="flex items-center justify-center mb-6">
        ...
        >
          <option value="" className="bg-white text-green-700 dark:bg-gray-700 dark:text-green-200">
            All Difficulties
          </option>
          <option value="Easy" className="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
            Easy 🌱
          </option>
          <option value="Medium" className="bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200">
            Medium 🌿
          </option>
          <option value="Hard" className="bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200">
            Hard 🌵
          </option>
        </select>
      </div>
