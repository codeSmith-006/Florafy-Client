...
const ExploreCategories = () => {
  return (
    <section className="py-12 px-4 md:px-12 bg-white text-gray-800 dark:bg-white dark:text-gray-900">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="card bg-white border border-gray-200 shadow-md p-6 hover:shadow-xl transition duration-300">
